...
export const newWatchProduction = (id:string) => {
  return {
    id,
    polishState: randomWeightedNumber([1,2,2,3,3,4,4,4,5,5,5,6,6,7,7,8,8,9,10]),
    movementState: randomWeightedNumber([1,2,2,3,3,4,4,4,5,5,5,6,6,7,7,8,8,9,10]),
    generalState: randomWeightedNumber([1,2,2,3,3,4,4,4,5,5,5,6,6,7,7,8,8,9,10])
  }
